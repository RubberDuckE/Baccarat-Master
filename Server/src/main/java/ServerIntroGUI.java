...
public class ServerIntroGUI extends Application implements Initializable {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("ServerIntroGUI.fxml"));
        primaryStage.setTitle("Baccarat Master Server");
    ...
    private void changeScene(ActionEvent event) throws IOException {
        Parent newRoot = FXMLLoader.load(getClass().getResource("ServerMainGUI.fxml"));
